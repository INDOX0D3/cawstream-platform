...
// Email verification link — the token is the credential, so it works even
...
Route::middleware('auth')->group(function () {
    ...
    // Everything below requires a verified email address (spec: dashboard
    // access is blocked until the account is verified).
...
Route::prefix('install')->middleware('install.lock')->name('install.')->group(function () {
    ...
    Route::post('/smtp', [InstallController::class, 'smtp'])->name('smtp');
